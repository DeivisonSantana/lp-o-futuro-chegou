<template>
    ...
    >
        ...
        >
            <p
                class="font-bold tracking-wider text-gray-300 text-7xl md:text-8xl lg:text-9xl"
            >
                500
            </p>
            <p
                class="mt-2 text-4xl font-bold tracking-wider text-gray-300 md:text-5xl lg:text-6xl"
            >
                Server Error
            </p>
            <p class="my-12 text-lg text-gray-500 md:text-xl lg:text-2xl">
                Esta página não existe, ou você não tem permissão para
                acessa-la.
            </p>
            <div class="flex items-center justify-center p-4">
                <button
                    class="p-2 duration-200 transform border-2 rounded-lg translate hover:scale-105"
                    @click="exitHome"
                >
                    Retornar para home
                </button>
